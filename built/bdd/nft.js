const nftsList = [
    {
        title: "Donkey #3429",
        description: "Collection of 10,000 Primates facilitating a seamless adoption of the web3 space through community fueled ventures and collaborations.",
        creator: "Mike Codeur",
    ...
    {
        title: "Outan #9876",
        description: "MadSkullz #5390 is one of the 6666 NFTs from MadSkullz Collection that are joining SkullzCity to fight for Freedomz.",
        creator: "Jules P",
    ...
    {
        title: "Dizzi #3856",
        description: "Please be aware that there are characters that look identical or very similar to English letters",
        creator: "Robert Z",
